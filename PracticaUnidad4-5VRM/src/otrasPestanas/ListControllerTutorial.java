...
public class ListControllerTutorial {
    ...
    void initialize() {
          ...
          webItem.getChildren().add(new TreeItem<String>("En esta pagina podremos elegir el animal al que apoyar,"
          		+ "\n la cantidad que queremos donar e informacion extra vista en un treeView"
          		+ " \n Al darle al bot�n de enviar nos saltara la primera alerta de si estamos seguros de querer hacer esa donacion y si aceptamos iremos a la siguiente pagina que es la de miembros"));
          rootItem.getChildren().add(webItem);
          webItem.getChildren().add(new TreeItem<String>("MIEMBROS"));
          webItem.getChildren().add(new TreeItem<String>("En el menu miembros veremos una tabla donde principalmente sale vac�a pero podemos anadir,modificar y borrar a los miembros"
          		+ "\n En el caso de que nos equivoquemos(por ejemplo olvidandonos un dato, o repitiendo una persona)  nos saltaran alertas al igual que al anadir,modificar y borrar"
